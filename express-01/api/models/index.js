...
// Associação RefreshToken <-> User
models.RefreshToken.belongsTo(models.User, { foreignKey: "userId", onDelete: "CASCADE" });
models.User.hasMany(models.RefreshToken, { foreignKey: "userId" });
